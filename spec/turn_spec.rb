...
RSpec.describe Turn do
  ...
  describe ":basic type" do
    ...
    it "the turn can have a winner" do
    ...
    it "awards cards won to winner" do
      winner = @turn.winner
...
# pry(main)> winner = turn.winner
  ...
  # #=> #<Deck:0x007fa3ee11ee48 @cards=[#<Card:0x007fa3ee14ef80...>, #<Card:0x007fa3eda3e1f0...>, #<Card:0x007fa3edad1cc0...>]>
   ...
   # it "has cards in both decks" do
  #   expect(@deck1).to eq([@card1, @card2, @card5, @card8])
  #   expect(@deck2).to eq([@card3, @card4, @card5, @card7])
  # end
